...
<Steps>
1. Add a section schema file to the `studio/schemas/objects/sections`
directory

2. A section schema file should have the following structure\:<Code lang="tsx" code={sectionSchema} title="studio/schemas/objects/sections/myNewSection.tsx" />

3. Add your newly created schema to the sections array located in the `studio/schema/index.ts` file.
