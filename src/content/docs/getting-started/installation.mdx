...
4. ### Initialize or link an existing Hydrogen storefront
    ...
    <Tabs>
      ...
      <TabItem label="Headless channel">
        The Headless channel is the right choice if you don't have a paid Shopify plan. It'll give you the exact same experience as
        the Hydrogen channel, except you won't be able to deploy your wesbite on Oxygen. You can install the [Headless channel
